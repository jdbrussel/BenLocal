    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <p class="mt-2 text-center text-sm text-gray-600 dark:text-gray-400">
                ...
                <Link :href="route('register')" class="font-bold text-amber-600 hover:text-amber-500">
                ...
                <form class="space-y-6" @submit.prevent="submit">
                    ...
                    <div class="flex items-center justify-between px-1">
                        <div class="flex items-center">
                            <input v-model="form.remember" id="remember-me" name="remember-me" type="checkbox"
                                class="h-5 w-5 text-amber-500 focus:ring-amber-500 border-gray-300 rounded-lg" />
                            <label for="remember-me" class="ml-3 block text-sm font-bold text-gray-600 dark:text-gray-400">
                                {{ $t('ui.auth.remember_me') }}
                            </label>
                        </div>

                        <div class="text-sm">
                            <a href="#" class="font-bold text-amber-600 hover:text-amber-500">
                    ...
                    <div>
                        <button type="submit" :disabled="form.processing"
                            ...
                            {{ form.processing ? '...' : $t('ui.auth.login') }}
                        </button>
                    </div>
                </form>
